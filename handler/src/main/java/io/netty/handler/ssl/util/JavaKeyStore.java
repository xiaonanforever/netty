...
public final class JavaKeyStore {
    ...
    /**
     * Creates a new {@link JavaKeyStore} instance.
     *
     ...
     * @param password the password or {@code null} if non is needed to load the {@link KeyStore}.
     ...
     */
    public JavaKeyStore(File jks, String alias, String password)
     ...
     * @throws NoSuchAlgorithmException
     */
    public JavaKeyStore(KeyStore ks, String alias, String password)
   ...
   private static PrivateKey privateKey(KeyStore ks, String alias, String password)
    ...
    private static String alias(KeyStore ks, String alias) throws KeyStoreException {
        ...
        if (aliases.size() == 1) {
            ...
            throw new KeyStoreException("unable to auto-select alias because more then one alias was found");
        }
    }
}
